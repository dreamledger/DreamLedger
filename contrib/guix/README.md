# Bootstrappable DreamLedger Core Builds

This directory contains the files necessary to perform bootstrappable DreamLedger
Core builds.
...
To build DreamLedger Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      DreamLedger Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/dreamledger-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/dreamledgerpay/guix.sigs).
...
[guix-docker]: https://github.com/dreamledger/tree/master/contrib/guix/Dockerfile
