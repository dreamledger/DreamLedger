...
EXPECTED_HOLDER_NAMES = [
    ...
    r"The DreamLedger Core developers",
    r"BitPay Inc\.",
...
Arguments:
    <base_directory> - The base directory of a DreamLedger Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The DreamLedger Core developers'
...
Arguments:
    <base_directory> - The base directory of DreamLedger Core source code repository.
"""
...
Arguments:
    <file> - A source file in the DreamLedger Core repository.
"""
