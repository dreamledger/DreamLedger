...
static UniValue gobject_prepare(const JSONRPCRequest& request)
{
    ...
    // This command is dangerous because it consumes 5 DLG irreversibly.
    // If params are lost, it's very hard to bruteforce them and yet
    // users ignore all instructions on dreamledgercentral etc. and do not save them...
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    { "dreamledger",               "getgovernanceinfo",      &getgovernanceinfo,      {} },
    { "dreamledger",               "getsuperblockbudget",    &getsuperblockbudget,    {"index"} },
    { "dreamledger",               "gobject",                &gobject,                {} },
    { "dreamledger",               "voteraw",                &voteraw,                {"tx_hash","tx_index","gov_hash","signal","outcome","time","sig"} },
