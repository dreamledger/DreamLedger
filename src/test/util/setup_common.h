...
/* Initialize DreamLedger-specific components after chainstate initialization */
void DreamLedgerTestSetup(NodeContext& node);
void DreamLedgerTestSetupClose(NodeContext& node);
