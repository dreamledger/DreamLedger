 ...
 *  We have 4 times smaller block times in DreamLedger, so we need to push 4 times more invs per 1MB. */
...
bool PeerManagerImpl::AlreadyHave(const CInv& inv)
{
    ...
    /*
        DreamLedger Related Inventory Messages
...
bool PeerManagerImpl::SendMessages(CNode* pto)
{
...

    {
        ...
        // DLG this code also handles non-TXs (DreamLedger specific messages)
