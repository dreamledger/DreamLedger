 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1710938844, nBits=1e0ffff0, nNonce=1547914, vtx=1)
...
{
    const char* pszTimestamp = "Welcome to the virtual reality";
    const CScript genesisOutputScript = CScript() << ParseHex("040a23b4f68e036daf34f75c1ab87f8491bcc5876f3a70de5b0d1b1a83073061d86454c9d741e0005b648e63e238003b80688e7e42b468691ceee851665f642212") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x0000025dcdb22428eaf7e292f94b14cf21be635afc15d8c45927ef283e43d4e8"); 
        ...
        genesis = CreateGenesisBlock(1710938844, 1547914, 0x1e0ffff0, 1, 20 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0000025dcdb22428eaf7e292f94b14cf21be635afc15d8c45927ef283e43d4e8"));
        assert(genesis.hashMerkleRoot == uint256S("0x7074758c906e27cbe11202287cf9e6c2fe801bbb2aa14927f219e861c418e66d"));
        ...
        vSeeds.emplace_back("n.dreamledger.eu");

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,30);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,31);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,158);
        // DreamLedger BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // DreamLedger BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};

        // DreamLedger BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"DAqP4X3sQKRJ1a7TDQFMK6w8GExs2sbf8G"};
        nMinSporkKeys = 1;

        checkpointData = {
            {
                {0, uint256S("0x0000025dcdb22428eaf7e292f94b14cf21be635afc15d8c45927ef283e43d4e8")},
            }
        };
        ...
        // getchaintxstats 17280 0000025dcdb22428eaf7e292f94b14cf21be635afc15d8c45927ef283e43d4e8
        chainTxData = ChainTxData{
                1710938844, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x00000e137a431127650abf877f1af3b818e52909281ff8b980ace34ac1717f8f"); 
        ...
        genesis = CreateGenesisBlock(1710938849UL, 596368UL, 0x1e0ffff0, 1, 20 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000e137a431127650abf877f1af3b818e52909281ff8b980ace34ac1717f8f"));
        assert(genesis.hashMerkleRoot == uint256S("0x7074758c906e27cbe11202287cf9e6c2fe801bbb2aa14927f219e861c418e66d"));
        ...
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,158);
        // Testnet DreamLedger BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet DreamLedger BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet DreamLedger BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"DTgYPagUtiWi42Hyb5RC81okqEJ5ZevQGM"};
        nMinSporkKeys = 1;

        checkpointData = {
            {
                {0, uint256S("0x00000e137a431127650abf877f1af3b818e52909281ff8b980ace34ac1717f8f")},
            }
        };
        ...
        // getchaintxstats 17280 00000e137a431127650abf877f1af3b818e52909281ff8b980ace34ac1717f8f
        chainTxData = ChainTxData{
                1710938849, // * UNIX timestamp of last known number of transactions
                0,    // * total number of transactions between genesis and that timestamp
                            //   (the tx=... number in the ChainStateFlushed debug.log lines)
                0,       // * estimated number of transactions per second after that timestamp
        };
...
public:
    explicit CDevNetParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1710938854, 1, 0x207fffff, 1, 20 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0e2fd041571d0696faba538688a324a896ae66dede6b4f837327117ca53badca"));
        assert(genesis.hashMerkleRoot == uint256S("0x7074758c906e27cbe11202287cf9e6c2fe801bbb2aa14927f219e861c418e66d"));

        devnetGenesis = FindDevNetGenesisBlock(genesis, 20 * COIN);
        ...
        checkpointData = (CCheckpointData) {
            {
                { 0, uint256S("0x0e2fd041571d0696faba538688a324a896ae66dede6b4f837327117ca53badca")},
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        // privKey: 6JEMZNt7wCi4jMKwspSbNQctqyVDpLCmodHEsUWCr6BytsKJmR4
        vSporkAddresses = {"DTD4GPFHpLFxxLDdp7hXdhDvcGe4dySD4m"};
        nMinSporkKeys = 1;
        ...
        // Regtest DreamLedger addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,30);
        // Regtest DreamLedger script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,31);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,158);
        // Regtest DreamLedger BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest DreamLedger BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest DreamLedger BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
