...
//! Interface for the src/evo part of a dreamledger node (dreamledgerd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/governance part of a dreamledger node (dreamledgerd process).
class GOV
{
public:
    virtual ~GOV() {}
...
//! Interface for the src/llmq part of a dreamledger node (dreamledgerd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a dreamledger node (dreamledgerd process).
...
//! Top-level interface for a dreamledger node (dreamledgerd process).
class Node
{
public:
    virtual ~Node() {}
