...
/** Utility functions used by the DreamLedger Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "dreamledger:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load dreamledger specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a dreamledger specific theme is activated (light/dark).*/
