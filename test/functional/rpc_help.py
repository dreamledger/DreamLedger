...
class HelpRpcTest(BitcoinTestFramework):
    ...
    def test_categories(self):
        ...
        # wrong argument count, note: DreamLedger's help allows for two options since we utilize subcommands
        ...
        components = ['Addressindex', 'Blockchain', 'Control', 'DreamLedger', 'Evo', 'Generating', 'Mining', 'Network', 'Rawtransactions', 'Util']
