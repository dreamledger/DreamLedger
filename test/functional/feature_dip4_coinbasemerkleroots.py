...
class LLMQCoinbaseCommitmentsTest(DreamLedgerTestFramework):
    def set_test_params(self):
        self.set_dreamledger_test_params(4, 3, fast_dip3_enforcement=True)
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as DreamLedgerTestFramework doesn't support this atm)
