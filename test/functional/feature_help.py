...
"""Verify that starting dreamledgerd with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start dreamledgerd with -h for help text")
        ...
        self.log.info("Start dreamledgerd with -version for version information")
        ...
        self.log.info("Start dreamledgerdd with -fakearg to make sure it does not start")
