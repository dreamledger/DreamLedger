Contributing to DreamLedger Core
============================

The DreamLedger Core project operates an open contributor model where anyone is
...
[good first issue](https://github.com/dreamledger/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list.
...
include:
  ...
  - *qt* for changes to dreamledger-qt
...
[Translation Process](https://github.com/dreamledger/blob/master/doc/translation_process.md)
...
The following applies to code changes to the DreamLedger Core project (and related
projects such as libsecp256k1), and is not to be confused with overall DreamLedger
Network Protocol consensus changes.

Whether a pull request is merged into DreamLedger Core rests with the project merge
...
Patches that change DreamLedger consensus rules are considerably more involved than
...
Where a patch set proposes to change the DreamLedger consensus, it must have been
...
The review process is normally fairly responsive on the DreamLedger Core repository, however
...
Bitcoin Backports are an incredibly valuable part of DreamLedger's development. Backporting allows us to easily implement new
features, improvements and fixes as bitcoin implements them.

To see detailed statistics & progress see Google Sheet tracker: [Bitcoin backports for DreamLedger](https://docs.google.com/spreadsheets/d/1DnKxat0S0H62CJOzXpKGPXTa8hgoVOjGYZzoClmGSB8/edit?usp=sharing).
...
The project leader is the release manager for each DreamLedger Core release.
