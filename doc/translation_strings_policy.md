...
This document provides guidelines for internationalization of the DreamLedger Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `dreamledger_en.ts` remains unchanged.
