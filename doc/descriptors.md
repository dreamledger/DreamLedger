# Support for Output Descriptors in DreamLedger Core

Since DreamLedger Core v0.17, there is support for Output Descriptors. This is a
...
existing DreamLedger Core wallets, a convenience function `combo` is
...
All RPCs in DreamLedger Core will include the checksum in their output. Only
