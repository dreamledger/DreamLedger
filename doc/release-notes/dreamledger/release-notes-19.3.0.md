# DreamLedger Core version v19.3.0
...
- `wipetxes`: New command for `dreamledger-wallet` that removes all wallet transactions
...
See detailed [set of changes](https://github.com/dreamledger/compare/v19.2.0...dreamledgerpay:v19.3.0).
