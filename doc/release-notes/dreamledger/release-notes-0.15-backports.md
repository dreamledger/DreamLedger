...
- [`595826ad6`](https://github.com/dreamledger/commit/595826ad6) Merge #12549: Make prevector::resize() and other prevector operations much faster
...
- [`b451094e2`](https://github.com/dreamledger/commit/b451094e2) Merge #11490: Disconnect from outbound peers with bad headers chains
...
- [`9a5b798e9`](https://github.com/dreamledger/commit/9a5b798e9) Merge #10957: Avoid returning a BIP9Stats object with uninitialized values
...
- [`74325db11`](https://github.com/dreamledger/commit/74325db11) Merge #10859: RPC: gettxout: Slightly improve doc and tests
...
- [`9f71ab04b`](https://github.com/dreamledger/commit/9f71ab04b) remove chainparams from method call (10758)
...
- [`c62c7ab6d`](https://github.com/dreamledger/commit/c62c7ab6d) Merge #10662: Initialize randomness in benchmarks
...
- [`e5c94eea0`](https://github.com/dreamledger/commit/e5c94eea0) Merge #10765: Tests: address placement should be deterministic by default
...
- [`33807c8ce`](https://github.com/dreamledger/commit/33807c8ce) Merge #11000: test: Add resendwallettransactions functional tests
...
- [`6320d516b`](https://github.com/dreamledger/commit/6320d516b) Merge #10535: [qa] fundrawtx: Fix shutdown race
...
- [`526036ead`](https://github.com/dreamledger/commit/526036ead) Merge #9804: Fixes subscript 0 (&var[0]) where should use (var.data()) instead.
...
- [`5eca7445a`](https://github.com/dreamledger/commit/5eca7445a) Merge #10412: Improve wallet rescan API
...
- [`61ca895c4`](https://github.com/dreamledger/commit/61ca895c4) Merge #10551: [Tests] Wallet encryption functional tests
...
- [`72a1b6f59`](https://github.com/dreamledger/commit/72a1b6f59) Use sync_with_ping to ensure that we don't start generating blocks too early
...
- [`6bfbe6053`](https://github.com/dreamledger/commit/6bfbe6053) Scripted diff `find src/ -name "*.cpp" ! -wholename "src/util.h" ! -wholename "src/util.cpp" | xargs perl -i -pe 's/(?<!\.)(ParseParameters|ReadConfigFile|IsArgSet|(Soft|Force)?(Get|Set)(|Bool|)Arg(s)?)\(/gArgs.\1(/g'` based on bb81e1735575e1c00e808326735168cc9810c174
...
- [`c4bd31a4e`](https://github.com/dreamledger/commit/c4bd31a4e) Merge #10404: doc: Add logging to FinalizeNode()
...
- [`31cc65c2e`](https://github.com/dreamledger/commit/31cc65c2e) Merge #10338: Maintain state across GetStrongRandBytes calls
...
- [`60aa17e0a`](https://github.com/dreamledger/commit/60aa17e0a) Merge #10180: [trivial] Fix typos (tempoarily → temporarily, inadvertantly → inadvertently)
...
- [`40fd1b168`](https://github.com/dreamledger/commit/40fd1b168) Make Consensus::LLMQType serializable and use it in serialized classes
...
- [`7fa60a1c7`](https://github.com/dreamledger/commit/7fa60a1c7) Merge #10219: Tests: Order Python Tests Differently
...
- [`a6eee07f2`](https://github.com/dreamledger/commit/a6eee07f2) Merge bitcoin#9963: util: Properly handle errors during log message formatting (#2917)
...
- [`9fa51cc66`](https://github.com/dreamledger/commit/9fa51cc66) Merge #10072: Remove sources of unreliablility in extended functional tests
- [`818ec218d`](https://github.com/dreamledger/commit/818ec218d) Merge #10128: Speed Up CuckooCache tests
- [`07ed44df6`](https://github.com/dreamledger/commit/07ed44df6) Merge #10136: build: Disable Wshadow warning
- [`b5968cd7a`](https://github.com/dreamledger/commit/b5968cd7a) Merge #10129: scheduler: fix sub-second precision with boost < 1.50
- [`16641e1b1`](https://github.com/dreamledger/commit/16641e1b1) Merge #10095: refactor: Move GetDifficulty out of `rpc/server.h`
- [`6edbc9ceb`](https://github.com/dreamledger/commit/6edbc9ceb) Merge bitcoin#9956: Reorganise qa directory (#2912)
- [`ace96a941`](https://github.com/dreamledger/commit/ace96a941) Drop xvfb and run tests in linux64_nowallet
- [`fc1b3772d`](https://github.com/dreamledger/commit/fc1b3772d) Merge #10899: [test] Qt: Use `_putenv_s` instead of setenv on Windows builds
- [`f8c3f9f7d`](https://github.com/dreamledger/commit/f8c3f9f7d) Merge #10142: Run bitcoin_test-qt under minimal QPA platform
- [`826846f15`](https://github.com/dreamledger/commit/826846f15) Review suggestions
- [`9cef545ac`](https://github.com/dreamledger/commit/9cef545ac) code review
- [`720f13d69`](https://github.com/dreamledger/commit/720f13d69) add a comment linking to xvfb documentation
- [`5f4519804`](https://github.com/dreamledger/commit/5f4519804) Merge #9734: Add updating of chainTxData to release process
- [`1914c2d78`](https://github.com/dreamledger/commit/1914c2d78) Merge #10038: Add mallocinfo mode to `getmemoryinfo` RPC
- [`de0919220`](https://github.com/dreamledger/commit/de0919220) Merge #10027: Set to nullptr after delete
- [`d56322285`](https://github.com/dreamledger/commit/d56322285) Merge #10033: Trivial: Fix typo in key.h comment
- [`22563f369`](https://github.com/dreamledger/commit/22563f369) Merge #10024: [trivial] Use log.info() instead of print() in remaining functional test cases.
- [`dd91bd7b3`](https://github.com/dreamledger/commit/dd91bd7b3) Merge #9911: Wshadow: various gcc fixes
- [`eea802738`](https://github.com/dreamledger/commit/eea802738) Merge #9987: Remove unused code
- [`6376da03f`](https://github.com/dreamledger/commit/6376da03f) Merge #9818: Save watch only key timestamps when reimporting keys
- [`8e0968faf`](https://github.com/dreamledger/commit/8e0968faf) Merge #9690: Change 'Clear' button string to 'Reset'
- [`aee4472ac`](https://github.com/dreamledger/commit/aee4472ac) Merge #9974: Add basic Qt wallet test
- [`ae9ca8459`](https://github.com/dreamledger/commit/ae9ca8459) Merge #10010: util: rename variable to avoid shadowing
- [`594b78fdf`](https://github.com/dreamledger/commit/594b78fdf) Merge #9921: build: Probe MSG_DONTWAIT in the same way as MSG_NOSIGNAL
- [`5ae202da9`](https://github.com/dreamledger/commit/5ae202da9) Merge #9842: Fix RPC failure testing (continuation of #9707)
- [`1cfda206a`](https://github.com/dreamledger/commit/1cfda206a) Merge #9993: Initialize nRelockTime
