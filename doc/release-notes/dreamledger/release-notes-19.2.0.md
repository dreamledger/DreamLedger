# DreamLedger Core version v19.2.0
...
At the first startup DreamLedger Core will run a migration process which can take
...
incompatible with older versions of DreamLedger Core, so a db migration path was
...
See detailed [set of changes](https://github.com/dreamledger/compare/v19.1.0...dreamledgerpay:v19.2.0).
