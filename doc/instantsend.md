...
This mechanism has been integrated into Bitcore-Node-DreamLedger which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/dreamledgerpay/insight-api-dreamledger#web-socket-api](https://github.com/dreamledgerpay/insight-api-dreamledger#web-socket-api)
* API: [https://github.com/dreamledgerpay/insight-api-dreamledger#instantsend-transactions](https://github.com/dreamledgerpay/insight-api-dreamledger#instantsend-transactions)
